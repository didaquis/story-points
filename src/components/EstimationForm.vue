<template>
	<form class="mb-4">
		<div class="form-group">
			...
			<select class="form-control" id="uncertaintySelect">
				<option></option>
		...
		<div class="form-group">
			...
			<select class="form-control" id="volumeOfWorkSelect">
				<option></option>
		...
		<button type="button" class="btn btn-primary px-5 mt-1">?</button>
	</form>
</template>
